...
export const NUMERIC_TO_ALPHA2: Record<string, string> = {
  ...
  "887": "YE", // Yemen
  "894": "ZM", // Zambia
  // Kosovo (not officially in ISO 3166-1 but commonly used)
  "-99": "XK", // Kosovo
};

/**
 * Get alpha-2 code from numeric or string ID
 */
export function getAlpha2Code(id: string | number): string | undefined {
